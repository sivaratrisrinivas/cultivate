...
class Config:
    ...
    AI = {
        ...
        "IMAGE_MODEL": os.getenv('XAI_IMAGE_MODEL', 'dall-e-3'),  # Image generation model
        ...
        "GENERATE_IMAGES": os.getenv('GENERATE_IMAGES', 'true').lower() == 'true'  # Toggle image generation
    }
